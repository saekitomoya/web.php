...
@section('character', 'キャラクター編集')
@section('content')
    <div class="container">
        <div class="">
            <div class="col-md-8 mx-auto">
                <h2>キャラクター</h2>
                   <form action="{{ action('Admin\CharacterController@update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="detail" value="{{$character->detail}}">
                        </div>
                    </div>
                    {{ csrf_field() }}
